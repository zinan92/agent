...
[![Snapshot](https://img.shields.io/badge/snapshot-113%20repos-0969DA.svg)](snapshot.yaml)
...
out 113-repo Agent map, grouped by function and owned/starred source
...
### Skills, Plugins & Marketplaces (39)
...
| [zinan92/skills-repo](https://github.com/zinan92/skills-repo) | 按 data/content/dev/trading 分类组织的 62 个 AI agent skills 仓库，用 frontmatter + symlink 把 skills 路由到 Claude Code 与 OpenClaw。 | Owned + Starred | owned source |
...
### Development Workflow & Quality (10)
